...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .bubble h3 { font-size: 16px; margin: 10px 0; }
        .bubble h4 { font-size: 14px; margin: 8px 0; color: #667eea; }
        .bubble ul { margin: 8px 0; padding-left: 20px; }
        .bubble li { margin: 5px 0; }
        .bubble strong { color: #667eea; }
        .examples {
            padding: 15px 20px;
            background: #f8f9fa;
...
<body>
    <div class="container">
        ...
        <div class="examples">
            ...
            <button class="example-btn" onclick="sendExample('We are missing inventory tracking in our warehouse')">📦 Gap Analysis</button>
